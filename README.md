...
- Criação da página de consultas;
...
- A página deve ser observada utilizando o node para rodar, com o comando "npm run dev".
- A home após login(dashboard.html) só pode ser acessada após realizar o login no sistema e, claro, precisa-se de um cadastro salvo no banco de dados antes.
